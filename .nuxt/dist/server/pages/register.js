...
var validatable = __webpack_require__(156);
...
"use strict";
/* harmony import */ var _src_components_VSnackbar_VSnackbar_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(169);
...
var loadable = __webpack_require__(141);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/register.vue?vue&type=template&id=0a1fc4ee&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-main',[_c('v-card',[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12"}},[_c('v-subheader',[_vm._v("Register")]),_vm._v(" "),_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-row',[_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.nameRules,"counter":10,"label":"First name","required":""},model:{value:(_vm.firstname),callback:function ($$v) {_vm.firstname=$$v},expression:"firstname"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.nameRules,"counter":10,"label":"Surname","required":""},model:{value:(_vm.lastname),callback:function ($$v) {_vm.lastname=$$v},expression:"lastname"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"counter":10,"label":"Middle Name"},model:{value:(_vm.middlename),callback:function ($$v) {_vm.middlename=$$v},expression:"middlename"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.emailRules,"label":"E-mail","required":""},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.regnumberRules,"label":"Reg Number","placeholder":"2018/123456","required":""},model:{value:(_vm.regnumber),callback:function ($$v) {_vm.regnumber=$$v},expression:"regnumber"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.passwordRules,"label":"Password","type":"password","required":""},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.passwordConfirmationRules,"label":"Confirm Password","type":"password","required":""},model:{value:(_vm.passwordConfirmation),callback:function ($$v) {_vm.passwordConfirmation=$$v},expression:"passwordConfirmation"}})],1)],1),_vm._v(" "),_c('v-btn',{staticClass:"mr-4",staticStyle:{"margin-left":"10px"},attrs:{"disabled":!_vm.valid,"color":"success"},on:{"click":_vm.validate}},[_vm._v("\n              Register")]),_vm._v(" "),_c('small',[_vm._v("Already have an account?\n              "),_c('nuxt-link',{attrs:{"to":"/login"}},[_vm._v(" Login")])],1)],1),_vm._v(" "),_c('v-snackbar',{attrs:{"timeout":2000},scopedSlots:_vm._u([{key:"action",fn:function(ref){
var attrs = ref.attrs;
return [_c('v-btn',_vm._b({attrs:{"color":"blue","text":""},on:{"click":function($event){_vm.loginHasError = false}}},'v-btn',attrs,false),[_vm._v("\n                Close\n              ")])]}}]),model:{value:(_vm.loginHasError),callback:function ($$v) {_vm.loginHasError=$$v},expression:"loginHasError"}},[_vm._v("\n            "+_vm._s(_vm.errorMessage)+"\n\n            ")])],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/register.vue?vue&type=template&id=0a1fc4ee&
...
/* harmony default export */ var registervue_type_script_lang_js_ = ({
  data() {
    return {
      ...
      passwordRules: [v => !!v || "Password is required", v => v && v.length >= 5 || "Password must be more than 5 characters"],
      passwordConfirmationRules: [v => !!v || "Password is required", v => v && v == this.password || "Password does not match"],
      regnumberRules: [v => !!v || "Registration number is required", v => /[0-9]{4}\/[0-9]{6}/.test(v) || "Registration number must be valid"],
...
var VBtn = __webpack_require__(181);
...
var VForm = __webpack_require__(184);
...
var VSnackbar = __webpack_require__(185);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VForm: VForm["a" /* default */],VMain: VMain["a" /* default */],VRow: VRow["a" /* default */],VSnackbar: VSnackbar["a" /* default */],VSubheader: VSubheader["a" /* default */],VTextField: VTextField["a" /* default */]})
